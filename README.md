...
# Remarks
This program act as a telegram client, and can be used to add subscribers to a target group. For channels, there is 200 subscribers limitations and only first 200 subscribers can be invited by the admin.
